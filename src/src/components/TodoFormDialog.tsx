...
import type { Importance, Todo, TodoInput } from "../types/todo";
import { IMPORTANCE_LABEL } from "./ImportanceBadge";
...
export function TodoFormDialog({
  ...
  const [limitDate, setLimitDate] = useState(initial?.limit_date ?? "");
